...
<Image src="/assets/society_logo_black.svg" alt="Society" width={32} height={32} className="dark:hidden shrink-0" />

{/* Version Blanche (cachée le jour, affichée la nuit) */}
<Image src="/assets/society_logo_white.svg" alt="Society" width={32} height={32} className="hidden dark:block shrink-0" />
          </div>
